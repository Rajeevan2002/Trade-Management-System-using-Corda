...
public class LoanRequestContract implements Contract{
    public static String ID = "com.bootcamp.contracts.LoanRequestContract";
    ...
    public void verify(LedgerTransaction tx) throws IllegalArgumentException
    {
        ...
        if(!(tx.getCommand(0).getSigners().contains(loanState.getReceiver().getOwningKey())))
            throw new IllegalArgumentException("Receiver Signature Received");
